...
// OpenAI API settings
$settings->add(new admin_setting_heading('assignfeedback_smartfeedback/openaiheading',
...
$settings->add(new admin_setting_configtext('assignfeedback_smartfeedback/apikey',
new lang_string('apikey', 'assignfeedback_smartfeedback'),
new lang_string('apikey_help', 'assignfeedback_smartfeedback'), '', PARAM_TEXT));

$settings->add(new admin_setting_configtext('assignfeedback_smartfeedback/model',
new lang_string('model', 'assignfeedback_smartfeedback'),
new lang_string('model_help', 'assignfeedback_smartfeedback'), 'gpt-4-turbo', PARAM_TEXT));

$settings->add(new admin_setting_configtext('assignfeedback_smartfeedback/maxtoken',
new lang_string('maxtoken', 'assignfeedback_smartfeedback'),
new lang_string('maxtoken_help', 'assignfeedback_smartfeedback'), '1024', PARAM_INT));
